...
LastEditTime: 2023-12-15 17:06:59
...
if not datasource_setting_file.is_file():
    ...
    set_json = {
        ...
        "datasets-origin": str(datasource_cache_dir.joinpath("datasets-origin")),
        "datasets-interim": str(datasource_cache_dir.joinpath("datasets-interim")),
    }
