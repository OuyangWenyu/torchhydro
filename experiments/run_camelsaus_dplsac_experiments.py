...
def run_camelsausdplsac(
    ...
    args = cmd(
        ...
        model_hyperparam={
            "n_input_features": len(VAR_T_CHOSEN_FROM_AUS)+len(VAR_C_CHOSEN_FROM_CAMELS_AUS),  # 21 + 17 = 38
...
run_camelsausdplsac(  # camels-aus time_range: ["1990-01-01", "2010-01-01"]
