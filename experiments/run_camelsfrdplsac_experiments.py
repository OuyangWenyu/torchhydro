...
def run_camelsfrdplsac(
    ...
    args = cmd(
        ...
        model_hyperparam={
            "n_input_features": len(VAR_T_CHOSEN_FROM_FR)+len(VAR_C_CHOSEN_FROM_CAMELS_FR),
...
run_camelsfrdplsac(  # camels-fr time_range: ["1970-01-01", "2022-01-01"]
    train_period=["1970-07-01", "1971-07-01"],
