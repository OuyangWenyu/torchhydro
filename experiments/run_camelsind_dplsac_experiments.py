...
run_camelsinddplsac(  # camels-ind time_range: ["1981-01-01", "2020-12-31"]
    train_period=["1981-07-01", "1982-07-01"],
    valid_period=["1982-10-01", "1983-10-01"],
    test_period=["1983-10-01", "1984-10-01"],
)
