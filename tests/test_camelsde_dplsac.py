...
@pytest.fixture
def camelsdedplsac_arg(var_c, var_t):
    """
    ...
    args = cmd(
        sub=os.path.join("test_camels", "dpllstmsac_camelsde"),
        # sub=os.path.join("test_camels", "dplannsac_camelsde"),
        source_cfgs={
...
def test_camelsdedplsac(camelsdedplsac_arg):
    train_and_evaluate(camelsdedplsac_arg)
