...
def test_stl_decomposition():
    ...
    print(decomposition)
# PASSED             [100%]
# time   streamflow trend      season  residuals  post_season  post_residuals
# 0      75.7   417.704512 -239.431983  88.430327  -248.257325       97.255669
# 1      105.0  319.680010 -240.100241  85.420231  -242.269446       87.589435
# 2      130.6  320.762285 -240.847365  80.685080  -238.719000       78.556715
# 3      158.0  321.848072 -241.129072  77.281000  -238.083354       74.235281
# 4      158.0  322.936940 -235.300234  70.363294  -238.171508       73.234569
# ...      ...         ...         ...        ...          ...             ...
# 11675   165.6 318.601656 -255.427477 -86.577036  -256.079079      -85.925433
