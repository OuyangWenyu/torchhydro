...
@pytest.fixture
def camelsdedpltank_arg(var_c, var_t):
    """
    ...
    args = cmd(
        sub=os.path.join("test_camels", "dpllstmtank_camelsde"),
        # sub=os.path.join("test_camels", "dplanntank_camelsde"),
        source_cfgs={
...
def test_camelsdedpltank(camelsdedpltank_arg):
    train_and_evaluate(camelsdedpltank_arg)
