...
def test_using_mock_dataset(dummy_data_cfgs):
    ...
    assert sample_x.shape == (dummy_data_cfgs["input_features"],)
    assert sample_y.shape == (dummy_data_cfgs["output_features"],)


@pytest.fixture()
def deep_hydro(dummy_data_cfgs):
    datasets_dict["MockDataset"] = MockDataset
