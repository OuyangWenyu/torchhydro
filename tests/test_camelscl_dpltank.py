...
@pytest.fixture
def camelscldpltank_arg(var_c,var_t):
    """
  ...
  # camels-cl time_range: ["1995-01-01", "2015-01-01"]
    ...
    args = cmd(
        sub=os.path.join("test_camels", "dpllstmtank_camelscl"),
        # sub=os.path.join("test_camels", "dplanntank_camelscl"),
        source_cfgs={
...
def test_camelscldpltank(camelscldpltank_arg):
    train_and_evaluate(camelscldpltank_arg)
