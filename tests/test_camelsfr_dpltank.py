...
@pytest.fixture
def camelsfrdpltank_arg(var_c, var_t):
    """
    ...
    return cmd(
        sub=os.path.join("test_camels", "dpllstmtank_camelsfr"),
        # sub=os.path.join("test_camels", "dplanntank_camelsfr"),
        source_cfgs={
...
def test_camelsfrdpltank(camelsfrdpltank_arg):
    config = default_config_file()
    update_cfg(config, camelsfrdpltank_arg)
