...
from test_arch_data import (
    ...
    camelsus_streamflow_01013500_80_005nan, camelsus_streamflow_01013500_80_035nan
)
...
def test_split_series_via_nan_mul_step():
    ...
    np.savetxt(r'D:\minio\waterism\datasets-origin\camels\camels_ystl\interpolation\subseries.txt', subseries)
    np.savetxt(r'D:\minio\waterism\datasets-origin\camels\camels_ystl\interpolation\indices_group.txt', indices_group)
    print("subseries = ", subseries)
