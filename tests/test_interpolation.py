...
def test_split_series_via_nan():
    ...
    p = 2
    subseries, indices = inter.split_series_via_nan(x, p)
...
def test_recover_series():
    ...
    x_interpolated = inter.recover_series(x, indices, interpolate_value)
...
def test_interpolate_ar():
    ...
    p = 2
    l = 1
    x_subseries, interpolate_value = inter.interpolate_ar(x, phi, p, l)
